...
INSERT INTO movies (
  movie_title, year_released, mpaa_rating, studios_id
)
...
VALUES ("Bruce Wayne", 1,1), ("Alfred", 1,2), ("Ra's Al Ghul", 1,3), ("Rachel Dawes", 1,4), ("Commissioner Gordon", 1,5),
...
("Heath Ledger"), ("Aaron Eckhart"), ("Maggie Gyllenhaal"), 
...
SELECT
movies.movie_title, movies.year_released, movies.mpaa_rating, studios.studio_name
FROM movies
...
SELECT
movies.movie_title, actors.actor_name, characters.character_name
FROM characters
